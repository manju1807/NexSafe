import KobodropLight from '../assets/logos/kobodrop_logo_bright.svg';
  ...
  return (
    <section className="bg-gray-800">
      <motion.div
        ...
        className="flex max-w-7xl flex-col px-8 py-12 text-gray-300 lg:px-12 xl:m-auto"
      >
        <div className="flex flex-col justify-between gap-12 md:flex-row md:gap-0">
          <div>
            <img
              className="mb-4 w-36"
              src={KobodropLight}
              alt="Light version of NexSafe logo"
            />
        ...
        <div className="mt-14 flex justify-between border-t-2 border-t-gray-700 pt-10">
          <p className="w-[16ch] text-gray-400 md:w-full">
            &copy; 2024 NexSafe. All rights reserved.
          </p>
